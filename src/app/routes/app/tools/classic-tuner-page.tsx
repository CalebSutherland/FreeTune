...
import { ActionIcon, Button, TableOfContents } from "@mantine/core";
          ...
          <div className="htu-main">
            ...
            <div className="htu-minor">
              ...
              <p>
                ...
                microphone access. The Classic Tuner always detects the closest
                note and dsiplays how sharp or flat it is.
              </p>
            </div>
            <div className="htu-minor">
