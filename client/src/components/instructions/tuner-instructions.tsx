      ...
      <div className="htu-content" id="tuner">
        <div className="htu-main">
          ...
          <div className="htu-minor">
            ...
            <p>
              ...
              access and load instrument sounds for note playback.
            </p>
          </div>
          <div className="htu-minor">
            <h3>Select Tuning</h3>
            ...
            <p>
              The tuner uses this selection to decide which notes to detect and
              display.
            </p>
            <div
              className="htu-card"
          ...
          <div className="htu-minor">
            ...
            <p>
              ...
              in the current tuning. When auto mode is off you manually select a
              target note using the <strong>Note Buttons.</strong>
            </p>
          </div>
          <div className="htu-minor">
            <h3>Note Buttons</h3>
            <div className="htu-card">
              <div className="example-buttons">
                {exampleButtons.map((note) => (
                  <button
                    key={note}
                    className={`note-button ${active === note ? "active" : ""}`}
        ...
        <div className="htu-main">
          ...
          <div className="htu-minor">
            <h3>Setup</h3>
            <p>
              Start the tuner and choose your preferred tuning preset. With Auto
              Mode enabled, the tuner will automatically detect and track the
              closest note you're playing. If you prefer manual control, simply
              click a note button to select a specific target note yourself.
            </p>
          </div>
          <div className="htu-minor">
            <h3>Tuning</h3>
